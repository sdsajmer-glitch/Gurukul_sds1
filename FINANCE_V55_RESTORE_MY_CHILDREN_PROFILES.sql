-- ==========================================
-- FIX_GET_MY_CHILDREN_PROFILES_V2
-- Objective: Restore get_my_children_profiles_v2 removed in V41 with unambiguous profile photo
-- ==========================================
...
BEGIN
    ...
    -- 3. Fetch via student_parents (Hardened mapping & Non-ambiguous photo)
    SELECT 
