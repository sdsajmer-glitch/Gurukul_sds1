-- Fix Missing Fee Tables and Apply RLS (Corrected Table References)
-- This script creates the missing fee_adjustments and student_fee_assignments tables and applies RLS.
-- It correctly references 'student_profiles' and 'school_branches' instead of non-existent tables.
