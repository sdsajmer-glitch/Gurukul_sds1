-- FIX: Resolve "column branch_id is of type uuid but expression is of type bigint" error
-- This script updates the record_fee_payment function to use the correct UUID type for branch_id

BEGIN;

-- Drop function first to ensure clean replacement if signature changed (though it didn't here, it's good practice)
