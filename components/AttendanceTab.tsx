...
const InsightAlert: React.FC<{ type: 'warning' | 'success' | 'info'; title: string; message: string }> = ({ type, title, message }) => {
    ...
    const icon = {
        ...
        success: <TrendingUpCustomIcon className="w-5 h-5 text-emerald-400" />,
                                                    ...
                                                    <td className="p-5 pl-6">
                                                        <div className="flex items-center gap-4">
                                                            <div className="relative">
                                                                ...
                                                                />
                                                                {status && (
                                                                    <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-card shadow-sm flex items-center justify-center ${status === 'Present' ? 'bg-emerald-500' :
