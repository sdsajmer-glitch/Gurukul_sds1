        ...
        <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 py-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 relative">
                ...
                {[
                    ...
                    >
                        <div className="relative">
                            <div className={`w-3.5 h-3.5 rounded-full transition-all duration-700 ${step.status === 'active' ? 'bg-primary shadow-[0_0_20px_rgba(var(--primary),1)] scale-110' : step.status === 'complete' ? 'bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.3)]' : 'bg-white/10'}`} />
                            {step.status === 'active' && <div className="absolute inset-0 bg-primary animate-ping rounded-full opacity-30" />}
                        </div>
                        <span className={`text-[12px] md:text-[14px] font-black uppercase tracking-[0.2em] transition-all duration-500 whitespace-nowrap ${step.status === 'active' ? 'text-white' : 'text-white/20'}`}>{step.label}</span>
                        {i < 2 && (
            ...
            <div className="text-center space-y-12 mb-20 relative py-12">
                ...
                <div className="relative">
                    ...
                    <div className="max-w-2xl mx-auto space-y-6">
                        ...
                        <div className="flex items-center justify-center gap-8 py-4">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[1em] text-white/10 whitespace-nowrap font-mono">Protocol: AES-256-XPN // SECURE CHANNEL</span>
                            <div className="h-px flex-grow bg-gradient-to-l from-transparent via-white/5 to-transparent" />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-12">
                    <div className="flex items-center gap-3 px-8 py-3 rounded-full border border-primary/20 bg-primary/5 shadow-2xl backdrop-blur-3xl">
                        <div className="w-2.5 h-2.5 rounded-full bg-primary animate-pulse shadow-[0_0_15px_rgba(var(--primary),1)]" />
                        <span className="text-[11px] font-black uppercase tracking-[0.4em] text-primary">Global Mesh Status: Operational</span>
                    </div>

                    <div className="inline-flex flex-col md:flex-row p-1.5 md:p-2 rounded-2xl md:rounded-3xl border border-white/5 bg-white/[0.02] backdrop-blur-3xl gap-2 md:gap-3 h-auto md:h-[72px] shadow-2xl w-full md:w-auto">
                        <button
                            onClick={() => handleOpenCreate()}
                            className="btn-secondary-premium border-none bg-transparent hover:bg-white/[0.05] h-14 md:h-full px-10 transition-all font-black text-[12px] md:text-[14px] tracking-widest uppercase opacity-60 hover:opacity-100"
                        >
                            Initialize New Node
                        </button>
                        <button className="btn-primary-premium h-14 md:h-full px-12 group transition-all text-[12px] md:text-[14px] font-black tracking-widest uppercase">
                            <div className="flex items-center gap-4">
                                <span>Synchronize Mesh</span>
                                <SparklesIcon className="w-4 h-4 opacity-60 group-hover:rotate-12 transition-transform" />
                            </div>
                        </button>
                    </div>
                </div>
                            ...
                            >
                                ...
                                <div className="mb-10 w-full flex items-center justify-between">
                                    ...
                                    {branch.is_main_branch ? (
                                        <div className="py-2.5 px-8 rounded-full border border-emerald-500/30 bg-emerald-500/5 backdrop-blur-3xl flex items-center justify-center gap-4 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-[9px] font-black text-emerald-500/30 uppercase tracking-[0.2em] mt-1 whitespace-nowrap">Global Master Hub Registry // LIVE</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className="py-2.5 px-8 rounded-full border border-white/10 bg-white/5 backdrop-blur-2xl flex items-center justify-center gap-4">
                                            <div className="w-2.5 h-2.5 rounded-full bg-white/40 shadow-[0_0_10px_rgba(255,255,255,0.2)]" />
                                            <div className="text-left">
                                                <p className="text-[13px] font-black text-white uppercase tracking-[0.3em] leading-none">Satellite Node</p>
                                                <p className="text-[9px] font-black text-white/20 uppercase tracking-[0.2em] mt-1 whitespace-nowrap">Active Institutional Peer</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="space-y-6 mb-16 relative z-10">
                                    ...
                                    <div className="flex items-center justify-center gap-3 p-1 rounded-full bg-white/[0.04] border border-white/10 pr-5 pl-2 py-2 backdrop-blur-3xl mx-auto w-fit shadow-xl">
                                        <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center border border-primary/20">
                                            <LocationIcon className="w-3 h-3 text-primary" />
                                        </div>
                                        <span className="text-[11px] font-black text-white/50 uppercase tracking-[0.25em] font-mono">
                                ...
                                <div className="w-full max-w-4xl px-12 flex items-center justify-center gap-12 mb-20 opacity-60">
                                    <span className="text-[11px] font-black uppercase tracking-[0.6em] text-white/30 whitespace-nowrap">Registry Sequence</span>
                                    <div className="h-px flex-grow bg-gradient-to-r from-transparent via-white/10 to-transparent" />
                                    <span className="text-[16px] font-mono font-black tracking-[0.4em] text-primary drop-shadow-[0_0_10px_rgba(var(--primary),0.4)]">{new Date(branch.created_at).getFullYear()}</span>
                                    <div className="h-px flex-grow bg-gradient-to-r from-transparent via-white/10 to-transparent" />
                                    <span className="text-[11px] font-black uppercase tracking-[0.6em] text-white/30 whitespace-nowrap">Active Matrix</span>
                                </div>
                                ...
                                <div className="w-full max-w-4xl mt-auto py-8">
                                    <div className="enterprise-glass rounded-3xl p-12 relative overflow-hidden group/vault hover:border-primary/40 transition-all duration-700 shadow-2xl bg-[#000000]/60">
                                        <div className="absolute top-8 left-8 flex items-center gap-4 opacity-30">
                                            <ShieldIcon className="w-4 h-4 text-primary" />
                                            <span className="text-[9px] font-mono text-white uppercase tracking-[0.3em]">SECURE ACCESS LEDGER // PROTOCOL V4</span>
                                        </div>
