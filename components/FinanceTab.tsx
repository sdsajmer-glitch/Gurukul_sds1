                            ...
                            <div className="flex flex-col md:flex-row gap-8 justify-between items-center bg-[#0d0f14]/90 p-5 rounded-[3rem] border border-white/5 backdrop-blur-xl ring-1 ring-white/5 shadow-[0_48px_96px_-24px_rgba(0,0,0,1)]">
                                ...
                                <div className="flex gap-4 pr-4">
                                     <button 
                                        ...
                                        className={`px-10 py-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] transition-all border shadow-2xl active:scale-95 ${
                                            riskOnly ? 'bg-red-500/10 text-red-500 border-red-500/30' : 'bg-white/[0.03] text-white/40 border-white/5'
                                        }`}
                                     >
                                         At-Risk Only
                                     </button>
                                                        ...
                                                        <td className="p-12">
                                                            <div className="w-72 mx-auto">
                                                                ...
                                                                <div className="h-2 w-full bg-white/[0.03] rounded-full overflow-hidden border border-white/5 p-0.5 shadow-inner group-hover:border-white/10 transition-colors">
                                                                    <div 
                                                                        className={`h-full rounded-full transition-all duration-2000 ease-[cubic-bezier(0.23,1,0.32,1)] shadow-[0_0_20px_rgba(0,0,0,0.5)] ${
                                                                            integrity >= 90 ? 'bg-emerald-500 shadow-emerald-500/20' : 
