                    ...
                    {currentBranch && (
                        isBranchAdmin ? (
                            <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/10 rounded-lg border border-primary/20">
                                ...
                                <span className="text-xs font-black text-primary uppercase tracking-wider truncate max-w-[150px] md:max-w-xs">{currentBranch.name}</span>
                            </div>
                        ) : (
                            <div className="flex items-center gap-2 group cursor-pointer overflow-hidden max-w-[150px] md:max-w-none">
                                ...
                                <ChevronDownIcon className="w-3 h-3 opacity-30 group-hover:opacity-100 hidden sm:block" />
                            </div>
                        )
                    )}
                </div>
