    ...
    return (
        <div className="w-full max-w-[1320px] mx-auto px-4 md:px-6 animate-in fade-in duration-1000">
            ...
            <header className="mb-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 relative">
                ...
                <div className="flex items-center gap-6 relative z-10 w-full md:w-auto no-print">
                    <button
            ...
            <div className="bg-white/[0.01] backdrop-blur-3xl p-6 rounded-[4rem] border border-white/5 shadow-[0_48px_96px_-24px_rgba(0,0,0,1)] mb-16 flex flex-col lg:flex-row gap-8 items-center no-print ring-1 ring-white/5 relative overflow-hidden group/ribbon">
                ...
                <div className="flex gap-6 w-full lg:w-auto overflow-x-auto no-scrollbar pb-1 lg:pb-0 px-2 lg:border-l border-white/5 lg:pl-8">
            ...
            <div className={`space-y-4 pb-48 transition-all duration-1000 ${expandedId !== null ? 'opacity-90' : 'opacity-100'}`}>
                {loading ? (
                    ...
                    <div className="py-64 text-center flex flex-col items-center gap-12 opacity-40 animate-in fade-in duration-1000">
                        <div className="w-48 h-48 bg-white/[0.01] rounded-[5rem] border-2 border-dashed border-white/5 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
